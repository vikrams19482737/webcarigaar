           ...
           <div className='section1'>
                 ...
                 <div className='s1-c1'>
                     ...
                     <div className='myicons1'>
                        <img data-aos="fade-up" src={imgApp1} alt="imgApp1" />
                        <img data-aos="fade-down" src={imgApp2} alt="imgApp2"/>
                     </div>
                 </div>
                 <div className='s1-c2'>
                      <img data-aos="fade-up" data-aos-duration="3000" className='cimg1' src={homeimage1} alt="homeimage1"  />
                 </div>
